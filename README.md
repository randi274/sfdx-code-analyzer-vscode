...
# Bugs and Feedback
To report issues or to suggest a feature enhancement with the Salesforce Code Analyzer VS Code Extension, log an [issue in Github](https://github.com/forcedotcom/code-analyzer/issues/).
...
- [Developer Doc: Salesforce Code Analyzer](https://forcedotcom.github.io/code-analyzer/)
